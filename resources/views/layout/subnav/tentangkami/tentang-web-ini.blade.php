      ...
      <div class="row y-gap-50 justify-between items-center">
        ...
        <div class="col-lg-6 pr-50 sm:pr-15">
          <div class="composition -type-8">
            <div class="-el-1"><img style="width: 400px; height: 400px;" src="{{asset('logotentangweb/p')}}" alt="$row->logo"></div>
          </div>
        </div>

        <div class="col-lg-5">
          <h2 class="text-30 lh-16">Pembina IT-Club SMKN 1 Garut</h2>
          <p class="text-dark-1 mt-30">Assalamualaikum</p>
          <p class="pr-50 lg:pr-0 mt-25">Waalaikumsalam</p>
        </div>
      </div>
