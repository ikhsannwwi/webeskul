                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    @foreach ($data as $row)
                      ...
                      <tr>
                        ...
                        <td>{{$row->isi}}</td>
                        <td>
                          <img src="{{asset('logotentangweb/'.$row->logoitc)}}" width="120px" alt="">
                        </td>
            ...
            <div class="card card-primary">
              ...
              <form action="/insertdatatentangweb" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputFile">Logo ITCLUB</label>
                        <input required type="file" class="form-control" name="logoitc" >
                    </div>
