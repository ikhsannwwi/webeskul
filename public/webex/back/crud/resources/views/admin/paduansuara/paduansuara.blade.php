                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    @foreach ($data as $row)
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="/editpaduansuara/{{$row->id}}" class="btn btn-info">Edit</a>
                          <a href="/deletepaduansuara/{{$row->id}}" class="btn btn-danger "  id="delete">Delete</a>
        ...
        <div class="row">
          ...
          <div class="col-md-12 mb-5">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/insertdatapaduansuara" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_instagram" id="exampleInputPassword1" placeholder="Masukan Nama Instagram Contoh (@paduansuara)">
                  </div>
