...
<div class="content-wrapper">
    ...
    <section class="content">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <a href="#tambahdatampk" style="z-index: 1" class="btn btn-success dark mt-2">Tambah Data</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    @foreach ($data as $row)
                      ...
                      <tr>
                        ...
                        <td>
                          <img src="{{asset('logoeskul/'.$row->logo)}}" width="30px" alt="">
                        </td>
                        <td>{{$row->pembina}}</td>
                        <td>{{$row->ketua}}</td>
                        ...
                        <td>
                          <a href="/editmpk/{{$row->id}}" class="btn btn-info">Edit</a>
                          <a href="/deletempk/{{$row->id}}" class="btn btn-danger "  id="delete">Delete</a>
      ...
      <div class="container-fluid" id="tambahdatampk">
        <div class="row">
          <!-- left column -->
          <div class="col-md-12 mb-5">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="/insertdatampk" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama_instagram" id="exampleInputPassword1" placeholder="Masukan Nama Instagram Contoh (@mpk)">
                  </div>
